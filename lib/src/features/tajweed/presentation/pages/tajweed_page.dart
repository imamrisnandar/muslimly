...
import '../../domain/usecases/get_tajweed_content.dart';
...
class _TajweedPageState extends State<TajweedPage> {
  ...
  void didChangeDependencies() {
    ...
    if (_currentLocale != l10n.localeName) {
      ...
      _dataFuture = getIt<GetTajweedContent>()(l10n.localeName);
    }
  }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Colors.white.withValues(alpha: 0.08), // Slightly lighter for contrast
