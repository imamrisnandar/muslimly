...
class HafalanSinglePage extends StatefulWidget {
  ...
  @override
  State<HafalanSinglePage> createState() => _HafalanSinglePageState();
}

class _HafalanSinglePageState extends State<HafalanSinglePage>
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        ...
                        color: isPeeking ? AppColors.accent : Colors.black54,
                        size: 24,
                      ),
                    ),
                  ),
  ...
  List<InlineSpan> _buildHafalanSpans(
    ...
    if (widget.surahNumber == 5) {
      debugPrint(
        '[QCF DEBUG] Surah 5 Ayah 1 has \${ayahWordCounts[1]} Text words.',
      );
    }
      ...
      if (cleanGlyph.length > 1) {
        ...
        for (int ci = 0; ci < contentText.length; ci++) {
          ...
          final bool isWordRevealed =
              revealedWordSet.contains(wordIdx) &&
          ...
          if (!isTargetSurah) {
            ...
            if (isWordMismatched) {
              ...
              charColor = Colors.black.withValues(
                alpha: 0.08,
              ); // Barely visible
            }
          } else {
